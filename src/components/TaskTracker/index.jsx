...
export default  function({tasks, todosActions, inprogressActions, completedActions}){
  ...
  return (
    <Grid container className={classes.root} spacing={4}>
      ...
      <Grid item xs={4}>
        <TaskList tasks={inprogress} actions={inprogressActions} listName="In Progress"/>
      </Grid>
      <Grid item xs={4}>
        <TaskList tasks={completed} actions={completedActions} listName="Completed"/>
      </Grid>
    </Grid>
  );
};
